...
describe('generateContentStream', () => {
    ...
    it('should should return a stream and aggregated response when passed text', async () => {
        ...
        expect(aggregatedResp.candidates[0]).toBeTruthy(`sys test failure on generateContentStream for testing candidates in aggregated response: ${aggregatedResp}`);
        expect(aggregatedResp.usageMetadata).toBeTruthy(`sys test failure on generateContentStream for testing usageMetadata in aggregated response: ${aggregatedResp}`);
    });
    it('in preview should should return a stream and aggregated response when passed text', async () => {
        ...
        const aggregatedResp = await streamingResp.response;
        expect(aggregatedResp.candidates[0]).toBeTruthy(`sys test failure on generateContentStream in preview for testing candidates in aggregated response: ${aggregatedResp}`);
        expect(aggregatedResp.usageMetadata).toBeTruthy(`sys test failure on generateContentStream in preview for testing usageMetadata in aggregated response: ${aggregatedResp}`);
    });
