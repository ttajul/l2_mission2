...
describe('GenerativeModel generateContent', () => {
    ...
    it('send timeout options to functions', async () => {
        ...
        spyOnProperty(modelWithRequestOptions, 'token', 'get').and.resolveTo(TEST_TOKEN);
...
describe('ChatSession', () => {
    ...
    describe('sendMessage', () => {
        ...
        it('send timeout to functions', async () => {
            ...
            spyOnProperty(chatSessionWithRequestOptions, 'token', 'get').and.resolveTo(TEST_TOKEN);
