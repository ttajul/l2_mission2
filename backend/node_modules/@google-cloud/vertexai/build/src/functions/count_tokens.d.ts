 ...
 */
export declare function countTokens(location: string, project: string, publisherModelEndpoint: string, token: Promise<any>, request: CountTokensRequest, apiEndpoint?: string, requestOptions?: RequestOptions): Promise<CountTokensResponse>;
