...
describe('generateContent', () => {
    ...
    it('request rejected when timeout', async () => {
        ...
        await expectAsync((0, generate_content_1.generateContent)(TEST_LOCATION, TEST_PROJECT, TEST_PUBLISHER_MODEL_ENDPOINT, TEST_TOKEN_PROMISE, req, TEST_API_ENDPOINT, TEST_GENERATION_CONFIG, TEST_SAFETY_SETTINGS, TEST_REQUEST_OPTIONS)).toBeRejected();
        expect(fetchSpy.calls.allArgs()[0][1].signal).toBeInstanceOf(AbortSignal);
    });
...
describe('generateContentStream', () => {
    ...
    it('request rejected when timeout', async () => {
        ...
        await expectAsync((0, generate_content_1.generateContentStream)(TEST_LOCATION, TEST_PROJECT, TEST_PUBLISHER_MODEL_ENDPOINT, TEST_TOKEN_PROMISE, req, TEST_API_ENDPOINT, TEST_GENERATION_CONFIG, TEST_SAFETY_SETTINGS, TEST_REQUEST_OPTIONS)).toBeRejected();
        expect(fetchSpy.calls.allArgs()[0][1].signal).toBeInstanceOf(AbortSignal);
    });
