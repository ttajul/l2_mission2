...
async function generateContent(location, project, publisherModelEndpoint, token, request, apiEndpoint, generation_config, safety_settings, requestOptions) {
    var _a, _b, _c;
 ...
 */
async function generateContentStream(location, project, publisherModelEndpoint, token, request, apiEndpoint, generation_config, safety_settings, requestOptions) {
    var _a, _b, _c;
    request = (0, pre_fetch_processing_1.formatContentRequest)(request, generation_config, safety_settings);
    (0, pre_fetch_processing_1.validateGenerateContentRequest)(request);
    if (request.generation_config) {
